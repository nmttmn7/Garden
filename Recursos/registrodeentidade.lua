...
function RegistroDeEntidade.Entidade:Construir(essencia,nome,saude,posicao)
...
function RegistroDeEntidade.Planta:Construir(essencia,tabela)
    local esse = RegistroDeEntidade.Entidade:Construir(essencia,tabela['nome'],tabela['saude'],tabela['posicao'])
